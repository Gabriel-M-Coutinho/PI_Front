                ...
                <form className="flex flex-col items-center w-full max-w-md gap-10">
                    ...
                    <div className="flex justify-between items-center w-full">
                        ...
                        <div className="flex justify-end w-full">
                                <span className="text-2xl text-white mr-1">R$19,90 - </span>
                            <CurrencyDollarIcon className="w-6 color-coin drop-shadow-md" />
                            <span className="text-xl text-white ml-1 mt-1">750</span>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center w-full">
                        ...
                        <div className="flex justify-end w-full">
                            ...
                            <CurrencyDollarIcon className="w-6 color-coin drop-shadow-md" />
                            <span className="text-xl text-white ml-1 mt-1">50</span>
                        </div>
                    </div>
                        ...
                        <div className="w-full flex justify-between">
                            ...
                            <div className="flex">
                                <span className="text-2xl text-white mr-1">R$19,90 - </span>
                                <CurrencyDollarIcon className="w-6 color-coin drop-shadow-md" />
                            <span className="text-xl text-white ml-1 mt-1">800</span>
                            </div>
                        </div>
                    {/* BOTÃO */}
                    <button
